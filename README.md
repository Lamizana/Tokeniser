...
Elle représente une **séquence de blocs reliés les uns aux autres** dans laquelle chaque bloc correspond a un ensemble de transaction. Elle se définit comme une **base de données stockée sur un réseau décentralisé**.
...
## Les différents type de blockchain
...
- c'est un app open source pour créer des jetons de cryptomonnaies

---

## Création de smart Contract

Remix permet de développer, compiler, déployer et tester des smart-contracts Ethereum.
